...
export default function Projects() {
  ...
  return (
    <div>
      ...
      {/* Toolbar row 1: Search + Filters + View + Export */}
      <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:10, flexWrap:'wrap' }}>
        <div style={{ display:'flex', alignItems:'center', gap:8, background:'#fff', border:'1px solid #e5e7eb', borderRadius:10, padding:'8px 14px', flex:1, maxWidth:380 }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
          <input style={{ border:'none', outline:'none', fontSize:13, color:'#374151', background:'none', width:'100%', fontFamily:'inherit' }} placeholder="Search projects, client, location..." />
          <span style={{ background:'#f3f4f6', border:'1px solid #e5e7eb', borderRadius:4, fontSize:10, color:'#6b7280', padding:'1px 5px', fontFamily:'monospace' }}>⌘K</span>
        </div>
        <button onClick={()=>{}} style={{ display:'flex', alignItems:'center', gap:7, background:'#fff', border:'1px solid #e5e7eb', borderRadius:10, padding:'8px 16px', fontSize:13, fontWeight:500, color:'#374151', cursor:'pointer', fontFamily:'inherit' }}>
        ...
        <button onClick={exportCSV} style={{ display:'flex', alignItems:'center', gap:7, background:'#fff', border:'1px solid #e5e7eb', borderRadius:10, padding:'8px 16px', fontSize:13, fontWeight:500, color:'#374151', cursor:'pointer', fontFamily:'inherit' }}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
          Export
        </button>
      </div>

      {/* Toolbar row 2: Delete Selected + New Project */}
      <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:22 }}>
        ...
        <button onClick={openAdd} style={{ display:'flex', alignItems:'center', gap:7, background:'#fff', border:'1px solid #e5e7eb', borderRadius:10, padding:'8px 20px', fontSize:13, fontWeight:600, color:'#374151', cursor:'pointer', fontFamily:'inherit' }}>
          New Project
        </button>
      </div>
