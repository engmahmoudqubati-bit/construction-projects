...
export default function Items() {
  ...
  const columns = [
    ...
    { key:'classification_name', label:'Classification', render: r=><span style={{fontSize:12,color:'#6b7280'}}>{r.classification_name||'—'}</span> },
    { key:'unit_code', label:'Unit', render: r=><span style={{fontSize:12,color:'#6b7280'}}>{r.unit_code||'—'}</span> },
