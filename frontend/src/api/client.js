...
export const api = {
  ...
  getOverviewDetails:      (pid) => request('GET', `/api/dashboard/overview-details${qs({ projectId: pid })}`),
  ...
  getFloorWeekly: (projectId, weekStart, weekEnd) => request('GET', `/api/reports/floor-weekly?projectId=${projectId}&weekStart=${weekStart}&weekEnd=${weekEnd}`),
